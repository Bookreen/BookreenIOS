...
final class FilterMyOfficeViewController: AppViewController {
    ...
    var viewModel: FilterMyOfficeViewModelProtocol!
    
    override func viewDidLoad() {
        super.viewDidLoad()
        
        [viewFloor,viewCampus,viewBuilding].forEach {
...
extension FilterMyOfficeViewController: FilterMyOfficeViewModelDelegate {
