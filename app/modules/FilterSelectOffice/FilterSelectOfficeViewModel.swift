...
struct FilterSelectOfficePresenter {
    let campusId: String
...
enum FilterSelectOfficeViewOutput {
...
protocol FilterSelectOfficeViewModelProtocol: AnyObject {
    var delegate: FilterSelectOfficeViewModelDelegate? { get set }
    var presenter: FilterSelectOfficePresenter { get set }
...
protocol FilterSelectOfficeViewModelDelegate: AnyObject {
    func handleOutput(_ output: FilterSelectOfficeViewOutput)
}

final class FilterSelectOfficeViewModel: FilterSelectOfficeViewModelProtocol {
    
    var delegate: FilterSelectOfficeViewModelDelegate?
    var presenter: FilterSelectOfficePresenter
    ...
    init(bookreenService: BookreenServiceProtocol, presenter: FilterSelectOfficePresenter) {
